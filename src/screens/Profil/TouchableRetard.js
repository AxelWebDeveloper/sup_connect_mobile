...
const TouchableRetard = () => {
  const navigation = useNavigation();

  const handlePress = () => {
    navigation.navigate('Retard');
  };
      ...
      <View style={styles.cardProfil1}>
        <View style={styles.textProfil}>
          <View style={styles.CardLogo}>
            <Ionicons name="time-outline" size={30} color="#EAAA6F" />
          </View>
          <Text style={styles.tileCardProfil}>Retards </Text>
...
export default TouchableRetard;
